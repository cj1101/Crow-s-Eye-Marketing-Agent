...
class ScheduleDialog(QDialog):
    ...
    def _init_ui(self) -> None:
        ...
        self.name_edit.setStyleSheet("padding: 8px; border: 1px solid #cccccc; border-radius: 4px;")
        ...
        self.mode_description.setStyleSheet("color: #666666; font-style: italic; margin-bottom: 10px;")
        ...
        # Days selection
        days_group_label = QLabel("Choose which days to post:")
        days_group_label.setStyleSheet("font-weight: bold; margin-bottom: 5px;")
        basic_layout.addWidget(days_group_label)
        ...
        # Posting time
        time_group_label = QLabel("Choose what time to post:")
        time_group_label.setStyleSheet("font-weight: bold; margin-top: 10px; margin-bottom: 5px;")
        basic_layout.addWidget(time_group_label)
        ...
        advanced_description.setStyleSheet("margin-bottom: 10px;")
        ...
        # Posts per week with styling
        posts_container = QWidget()
        posts_container.setStyleSheet(container_style)
        posts_container_layout = QVBoxLayout(posts_container)
        
        posts_title = QLabel("Posting Frequency")
        posts_title.setStyleSheet("font-weight: bold; margin-bottom: 5px;")
        posts_container_layout.addWidget(posts_title)
        
        posts_layout = QHBoxLayout()
        posts_label = QLabel("Posts per Week:")
        ...
        date_title = QLabel("Schedule Duration")
        date_title.setStyleSheet("font-weight: bold; margin-bottom: 5px;")
        date_container_layout.addWidget(date_title)
        ...
        start_label.setStyleSheet("font-weight: bold; margin-bottom: 5px;")
        self.start_calendar = QCalendarWidget()
        self.start_calendar.setMinimumDate(datetime.now().date())
        self.start_calendar.setMaximumHeight(250)
        ...
        end_label.setStyleSheet("font-weight: bold; margin-bottom: 5px;")
        self.end_calendar = QCalendarWidget()
        self.end_calendar.setMinimumDate(datetime.now().date())
        self.end_calendar.setMaximumHeight(250)
    ...
    def _load_schedule_data(self) -> None:
        ...
        try:
            ...
            self.posts_spin.setValue(self.schedule_data.get("posts_per_week", 3))
            ...
            if self.schedule_data.get("mode") == "Basic":
                # Set days
                ...
                # Set time
                time_str = self.schedule_data.get("time", "12:00")
                try:
                    hours, minutes = map(int, time_str.split(":"))
                    self.time_edit.setTime(datetime.now().replace(hour=hours, minute=minutes).time())
                except ValueError:
                    pass
    ...
    def _save_schedule(self) -> None:
        ...
        try:
            ...
            schedule_data = {
                ...
                "name": name,
                "mode": mode,
                "posts_per_week": self.posts_spin.value(),
